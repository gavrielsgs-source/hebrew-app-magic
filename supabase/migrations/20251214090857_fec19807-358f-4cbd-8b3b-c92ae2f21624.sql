...
-- Insert all 12 default templates for all existing users
...
CROSS JOIN (
  VALUES 
    -- Car templates (9)
    ('תבנית רכב מלאה', 'תבנית מפורטת עם כל פרטי הרכב והקונטקט', 'car', 'שלום לקוח יקר! 👋
...
בברכה,
צוות המכירות', NULL),
    ('מפרט מפורט', 'הודעה מפורטת עם כל המפרטים הטכניים', 'car', '🚗 *{{carName}}*
...
בברכה,
צוות המכירות', NULL),
    ('מעקב שני', 'הודעה לטיפול בפנייה קיימת', 'car', 'שלום, 👋
...
צוות המכירות', NULL),
    -- Lead templates (3)
    ('ברוכים הבאים - לקוח חדש', 'הודעת ברכה ללקוח שנוסף למערכת', 'lead', 'שלום {{customerName}}! 👋

קיבלנו את פנייתך 🙏 

צוות המכירות שלנו יחזור אליך בקרוב 😊', 'customer_welcome'),
...
בברכה,
צוות המכירות', true, 'car_template'),
