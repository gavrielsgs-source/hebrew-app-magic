      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-white/50 mb-12">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#2F3C7E]">הסיפור שלנו</h3>
            <p className="text-gray-700 leading-relaxed">
              "אני גבריאל, סוחר רכב עם שנים של ניסיון בתחום. במהלך השנים נתקלתי בכל הבעיות שאתם מכירים: 
              לידים שנעלמים, לקוחות שלא עונים, קושי במעקב אחר מלאי הרכבים, וחוסר יכולת לנתח נתונים בצורה חכמה. 
              בניתי את CarsLead כדי לפתור בדיוק את הבעיות האלה - מערכת שמבינה את הצרכים האמיתיים שלכם כסוחרי רכב."
            </p>
          </div>
        </div>
      </section>
