...
import { extractYouTubeVideoId, generateYouTubeEmbedUrl, generateYouTubeThumbnail } from '@/lib/youtube-utils';

interface DemoSectionProps {
  onVideoOpen?: () => void; // Made optional since we won't use modal anymore
}
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-4 md:p-8">
            <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden relative">
              {videoPlaying && embedUrl ? (
                ...
                // Thumbnail and play button when not playing
                <>
                  {/* YouTube Thumbnail */}
                  {thumbnailUrl && (
                    <img
                  ...
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-black/20 hover:bg-black/30 transition-all duration-300 cursor-pointer" 
