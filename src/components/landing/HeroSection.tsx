        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-right space-y-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <span className="block mt-2 text-base lg:text-lg font-medium text-[#2F3C7E]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
              <Button 
                ...
                className="bg-gradient-to-r from-[#2F3C7E] to-[#4CAF50] hover:from-[#1A2347] hover:to-[#45A049] text-white px-8 py-5 text-lg lg:text-xl rounded-2xl shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105 hover:-translate-y-1"
              >
              ...
              <Button 
                ...
                size="lg"
                onClick={onVideoOpen}
                className="text-gray-600 hover:text-[#2F3C7E] px-8 py-5 text-lg lg:text-xl transition-all hover:bg-white/60 rounded-2xl"
              >
            ...
            <div className="pt-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl lg:text-3xl font-bold text-[#4CAF50] mb-1">24/7</div>
                  <div className="text-xs text-gray-500">תמיכה</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl lg:text-3xl font-bold text-[#2F3C7E] mb-1">99%</div>
                  <div className="text-xs text-gray-500">זמינות</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl lg:text-3xl font-bold text-[#4CAF50] mb-1">+15K</div>
                  <div className="text-xs text-gray-500">לידים חודשיים</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl lg:text-3xl font-bold text-[#2F3C7E] mb-1">98%</div>
