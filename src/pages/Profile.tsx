      ...
      <MobileContainer className="bg-gray-50" withPadding={false}>
        <div className="space-y-4 p-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="bg-gradient-to-l from-blue-600 to-purple-600 p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-200 flex justify-start">
                      <Button 
                        ...
                        className="bg-gradient-to-l from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white h-12 px-6 rounded-lg font-medium transition-all duration-200 flex items-center gap-3 w-full"
                      >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-gray-200 flex justify-start">
                    <Button 
                      type="submit" 
                      disabled={updateProfile.isPending}
                      className="bg-gradient-to-l from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white h-12 px-8 rounded-lg font-medium transition-all duration-200 flex items-center gap-3"
                    >
                      <Save className="h-4 w-4" />
                      {updateProfile.isPending ? "שומר שינויים..." : "שמור שינויים"}
                    </Button>
