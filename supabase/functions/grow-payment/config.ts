...
if (!GROW_CLIENT_ID) throw new Error('GROW_CLIENT_ID environment variable is required');
if (!GROW_EC_PWD) throw new Error('GROW_EC_PWD environment variable is required');
