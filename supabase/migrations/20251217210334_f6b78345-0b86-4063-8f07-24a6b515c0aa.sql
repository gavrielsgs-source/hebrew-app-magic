-- Revert car_template to original content (without {{8}})
...
צוות המכירות'
WHERE name = 'תבנית רכב מלאה' AND facebook_template_name = 'car_template';

-- Also revert the function to original
