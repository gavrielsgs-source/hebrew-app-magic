...
import { Zap, MessageSquare, Clock, Car, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto" dir="rtl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">אוטומציות WhatsApp</h1>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) => update("followup1_enabled", v)}
                    />
                  </div>
