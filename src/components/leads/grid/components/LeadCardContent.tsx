...
export function LeadCardContent({ lead }: LeadCardContentProps) {
  ...
  console.log("Lead data in card:", lead);
  ...
  return (
    <CardContent className="p-0">
      <div className="space-y-5" dir="rtl">
        ...
        {lead.notes && (
          <div
            className="leads-notes bg-amber-50 dark:bg-amber-950/20 border-2 border-amber-200 dark:border-amber-800 p-4 rounded-xl shadow-md"
            dir="rtl"
          >
        ...
        <div className="grid grid-cols-1 gap-4">
          {lead.phone && (
            <div
              className="flex items-center justify-end bg-muted/30 p-4 rounded-xl border border-muted/50 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.01]"
              dir="rtl"
            >
              <div className="text-right flex-1">
        ...
        {lead.assigned_to && (
          <div
            className="flex items-center justify-end bg-muted/20 p-4 rounded-xl border border-muted/40 hover:shadow-md transition-all duration-300 hover:scale-[1.01]"
            dir="rtl"
          >
            <div className="text-right flex-1">
              <span className="text-sm font-semibold text-foreground">{lead.profiles?.full_name || "לא ידוע"}</span>
        ...
        {lead.cars && (
          <div
            className="bg-primary/5 p-5 rounded-2xl border border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.01]"
            dir="rtl"
          >
            <div className="flex items-start justify-end gap-4">
              <div className="text-right flex-1">
                ...
                {lead.cars.price && (
                  <div className="text-xl font-bold text-foreground mb-1">{lead.cars.price.toLocaleString()} ₪</div>
                )}
